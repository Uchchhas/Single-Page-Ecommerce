                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-sm-10 col-md-10 col-lg-10 col-xl-9">
                        <div class="faq-wrapper">
                            <h4 class="text-center font-weight-bold mb-3">F.A.Q</h4>
                                    ...
                                    <div id="headingOne" class="card-header bg-white border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#"
                                               ...
                                               class="d-block position-relative text-dark collapsible-link py-3">
                                    ...
                                    <div id="headingTwo" class="card-header bg-white border-0">
                                        <h6 class="mb-0 font-weight-bold">
                                            <a href="#"
                                               ...
                                               class="d-block position-relative collapsed text-dark collapsible-link py-3">
